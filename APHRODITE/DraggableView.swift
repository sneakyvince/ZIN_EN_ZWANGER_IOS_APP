...
class DraggableView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        information = UITextView(frame: CGRectMake(0, 50, self.frame.size.width, 100))
        information.text = "no info given"
        information.textAlignment = NSTextAlignment.Center
        information.textColor = UIColor.blackColor()
        information.font = UIFont(name:"HelveticaNeue", size: 18.0)
        ...
        overlayView = OverlayView(frame: CGRectMake(self.frame.size.width/2-100, 0, 75, 75))
        overlayView.alpha = 0
